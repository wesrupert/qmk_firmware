...
enum tap_dances {
    TAP_DANCE_DYN_MACRO = 0,
    TAP_DANCE_PLAYPAUSE_SPOTIFY,
    X_TAP_DANCE
};

enum layers {
    /* Personal maps */ LAYER_BASE = 0, LAYER_FUNCTION, LAYER_SYMBOLS, LAYER_NUMPAD,
    LAYER_ENUM_END
};
...
#define LT_SPFN LT(LAYER_FUNCTION, KC_SPC)
...
[LAYER_BASE] = LAYOUT_ergodox_pretty(
    KC_DEL,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,       KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
    ...
    KC_LALT, MC_MUTE, MC_VOLD, MC_VOLU, KC_LGUI,                                        KC_RGUI, MC_MPRV, TD_PLSP, MC_MNXT, KC_RALT,
                                                 LT_NMPD, TD_DYMC,    KC_LEAD, LT_NMPD,
                                        /*-----\ /-----*/ KC_DOWN,    KC_UP,   /*-----\ /-----*/
                                        LT_SPFN, LT_SYEN, KC_LEFT,    KC_RGHT, LT_SYBS, LT_SPFN)
,
[LAYER_FUNCTION] = LAYOUT_ergodox_pretty(
    ...
    XXXXXXX, MC_MPRV, MC_MPLY, MC_MNXT, XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  MC_PSCR, XXXXXXX,
    _______, MC_VOLD, MC_MUTE, MC_VOLU, XXXXXXX, XXXXXXX,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, MC_PSCF, _______,
    ...
    _______, _______, _______, _______, _______,                                        _______, _______, _______, _______, _______,
                                                 KC_ESC,  MC_LOCK,    MC_LOCK, KC_ESC,
                                        /*-----\ /-----*/ KC_PGUP,    KC_PGDN, /*-----\ /-----*/
                                        _______, KC_ENT,  KC_HOME,    KC_END,  KC_BSPC, _______)
,
[LAYER_SYMBOLS] = LAYOUT_ergodox_pretty(
    ...
    _______, MA_OR,   KC_PIPE, KC_SLSH, KC_MINS, KC_QUES, KC_LPRN,    KC_RPRN, KC_EXLM, KC_PLUS, KC_ASTR, KC_AMPR, MA_AND,  _______,
    _______, MA_AND,  KC_LBRC, KC_LCBR, KC_LPRN, KC_LABK,                      KC_RABK, KC_RPRN, KC_RCBR, KC_RBRC, MA_OR,   _______,
    _______, XXXXXXX, MA_PBRC, MA_PCBR, MA_PPRN, MA_PABK, MA_BRNL,    MA_LMBD, MA_PABK, MA_PPRN, MA_PCBR, MA_PBRC, MA_PCMT, _______,
    _______, _______, _______, _______, _______,                                        _______, _______, _______, _______, _______,
